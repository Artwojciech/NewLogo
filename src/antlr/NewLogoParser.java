...
public class NewLogoParser extends Parser {
	...
	public static final int
		...
		COMMA=27, SEMICOLON=28, FORWARD=29, LTURN=30, RTURN=31, LINECOL=32, LINEWIDTH=33, 
		CHANGEBG=34, CLEAR=35, ISBORDER=36, VARIABLE=37, INT=38, CHAR=39, STRING=40, 
		BOOL=41, LBRACKET=42, RBRACKET=43, LCURLY=44, RCURLY=45, WHITESPACE=46, 
		NEWLINE=47, REPEAT=48, WHILE=49, RETURN=50, BREAK=51, IF=52, ELSE=53, 
		PRINT=54, COMMENT=55;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'=='", "'!='", "'<='", "'>='", "'<'", "'>'", "'||'", "'&&'", "'!'", 
			"'='", "'+='", "'-='", "'*='", "'/='", "'++'", "'--'", "','", "';'", 
			"'forward'", "'lturn'", "'rturn'", "'linecol'", "'linewidth'", "'changebg'", 
			"'clear'", "'isborder'", null, "'int'", "'char'", "'string'", "'bool'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CLEAR", "ISBORDER", "VARIABLE", "INT", "CHAR", "STRING", "BOOL", "LBRACKET", 
			"RBRACKET", "LCURLY", "RCURLY", "WHITESPACE", "NEWLINE", "REPEAT", "WHILE", 
			"RETURN", "BREAK", "IF", "ELSE", "PRINT", "COMMENT"
		};
	}
	...
	public final CallArgumentsContext callArguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4535485989054L) != 0)) {
				{
				setState(216);
				value();
				setState(221);
